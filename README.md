...
![Impact Digital Marketing & Technology Agency Banner](public/banner.svg)

# Impact Digital Marketing & Technology Agency
### وكالة إمباكت للتسويق الرقمي والحلول البرمجية

[![Project ID](https://img.shields.io/badge/Project_ID-sd-08-impact-digital-agency-06b6d4.svg?style=for-the-badge)]()
...
**🇸🇦 معرض أعمال وكالة تسويق رقمي وحلول برمجية حديثة، يستعرض خدمات تطوير الويب، واستراتيجيات SEO، وتصميم UI/UX ودراسات الحالة للعملاء.**  
**🇺🇸 A cutting-edge digital marketing & software agency portfolio showcasing web development, SEO strategies, UI/UX design, and client case studies.**
...
يمثل مشروع **وكالة إمباكت للتسويق الرقمي والحلول البرمجية** تطبيق ويب حديث وفاخر تم تطويره ليكون نموذجاً احترافياً ريادياً في قطاع **التسويق الرقمي، هندسة البرمجيات وتطوير العلامات التجارية**.

- **قطاع الأعمال**: التسويق الرقمي، هندسة البرمجيات وتطوير العلامات التجارية
- **فلسفة التصميم**: تعتمد الفلسفة البصرية على السلاسة، والجماليات العصرية، مع استخدام الألوان المناسبة للقطاع (**Electric Violet & Cyber Cyan / بنفسجي كهربائي وسيان رقمي**)، وتحقيق أقصى درجات تجربة المستخدم (UX).
...
**Impact Digital Marketing & Technology Agency** is a state-of-the-art web application developed to demonstrate production-grade engineering in the **Digital Marketing, Web Engineering & Creative Agency Services** sector.

- **Business Sector**: Digital Marketing, Web Engineering & Creative Agency Services
- **Design Philosophy**: Built around visual elegance, high-contrast typography, tailored color schemes (**Electric Violet & Cyber Cyan / بنفسجي كهربائي وسيان رقمي**), and intuitive user interaction flows.
...
- ✔ **معرض أعمال استعراضي مبهر يحتوي على مؤثرات الحركة والسلاسة الإنسيابية.**
- ✔ **باقة خدمات متكاملة تغطي البرمجة، التسويق الإلكتروني، وتجربة المستخدم UI/UX.**
- ✔ **جدول باقات وأسعار شفاف يساعد العملاء على اختيار الخطة الناجحة.**
- ✔ **مدونة رقمية غنية تتيح نشر المقالات وإرشادات النمو التقني والتسويقي.**
- ✔ **دعم كامل ومبهر للغتين العربية والإنجليزي بتجربة بصرية حديثة ومستقبلية.**

## 🇺🇸 English

- ✔ **Visually striking agency showcase utilizing smooth Framer Motion micro-animations.**
- ✔ **Full-spectrum service offerings spanning custom development, SEO growth, and UI/UX design.**
- ✔ **Transparent pricing matrices helping clients pick suitable retainer or project plans.**
- ✔ **Rich insights blog publishing tech engineering tutorials and digital strategy guides.**
- ✔ **State-of-the-art bilingual interface designed with futuristic dark mode aesthetics.**
...
تم بناء الهوية البصرية لمشروع **وكالة إمباكت للتسويق الرقمي والحلول البرمجية** لتعكس الاحترافية العالية والدقة الشديدة:
- **نظام الألوان**: اختيار وتنسيق ألوان **Electric Violet & Cyber Cyan / بنفسجي كهربائي وسيان رقمي** لخلق انطباع مبهر وفخم.
...
The design system for **Impact Digital Marketing & Technology Agency** is engineered around premium aesthetics:
- **Palette**: Mastered palette around **Electric Violet & Cyber Cyan / بنفسجي كهربائي وسيان رقمي** evoking trust, prestige, and focus.
...
- **`/`**: الصفحة الرئيسية - واجهة الترحيب التفاعلية، الخدمات، وأبرز الإحصائيات
- **`/services`**: الخدمات الرقمية - تطوير تطبيقات الويب، الحملات الإعلانية، وSEO
- **`/portfolio`**: معرض الأعمال - دراسات الحالة للمشاريع السابقة ونتائج المبيعات
- **`/pricing`**: الباقات والأسعار - باقات الاستشارات والتطوير والتسويق الشهري
- **`/blog`**: المدونة الرقمية - مقالات في البرمجة والتسويق الرقمي وتجربة المستخدم
- **`/contact`**: ابدأ مشروعك - استمارة طلب المشروع والاستشارات الرقمية

## 🇺🇸 English

- **`/`**: Home Page - Interactive agency hero, core services grid, and growth metrics
- **`/services`**: Agency Services - Full-stack web development, SEO growth, and digital branding
- **`/portfolio`**: Client Portfolio - Case studies, measurable results, and client testimonials
- **`/pricing`**: Pricing Plans - Transparent monthly packages for startups and enterprise
- **`/blog`**: Digital Blog - Industry insights, SEO tactics, and tech news articles
- **`/contact`**: Start Project - Project intake form, budget calculator, and office details
...
git clone https://github.com/malsalimi/sd-08-impact-digital-agency.git

# 2. Navigate into the project folder | الانتقال لتركي المشروع
cd impact-digital-agency
